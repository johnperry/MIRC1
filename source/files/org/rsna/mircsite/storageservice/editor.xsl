...
<xsl:param name="date"/>
<xsl:param name="edit-owner"/>
<xsl:param name="icons"/>
<xsl:param name="mode"/>
<xsl:param name="options"/>
<xsl:param name="species"/>
<xsl:param name="version">T29</xsl:param>
...
<xsl:template match="/MIRCdocument">
	<html>
		<head>
			...
			<link rel="Stylesheet" type="text/css" media="all" href="{$context}/editor.css"> </link>
			<xsl:if test="$mode='vet'">
				<xsl:call-template name="vet-breed-list"/>
			</xsl:if>
			<xsl:call-template name="unsupported-elements"/>
			...
			<script src="{$context}/editor.js"> </script>
			<script src="{$context}/svg-editor.js"> </script>
		</head>
		<body>
			...
			<script language="JavaScript" type="text/javascript" src="/mirc/wz_tooltip.js">;</script>
		</body>
	</html>
</xsl:template>

<xsl:template name="unsupported-elements">
	<script>
	...
	<div id="toolbar" class="toolbar">
		<span class="group">
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/show.gif</xsl:with-param>
		...
		<span class="group">
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/save.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/preview.gif</xsl:with-param>
		...
		<span class="group">
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/insertsection.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/cut.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/left.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/right.gif</xsl:with-param>
		...
		<span class="group">
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/insertparagraph.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/insertcaption.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/insertimage.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/insertpatient.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/insertiframe.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/insertquiz.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/up.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">buttons/down.gif</xsl:with-param>
				...
				<tr>
					...
					<td>
						...
						<img onclick="setDocref(event);"
							...
							<xsl:attribute name="src">
								<xsl:value-of select="$context"/>
								<xsl:text>/buttons/left-small.gif</xsl:text>
							</xsl:attribute>
						</img>
					</td>
				</tr>
...
<xsl:template name="author-service-form">
	<form id="author-service-form" method="post" accept-charset="UTF-8">
		<xsl:attribute name="action"><xsl:value-of select="$servlet"/></xsl:attribute>
		...
		<input type="hidden" id="doctext" name="doctext" value=""></input>
		<input type="hidden" id="preview" name="preview" value=""></input>
	...
	<div id="svgToolPalette" class="svgToolPalette">
		<p class="svgToolP">
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/quit.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/save.gif</xsl:with-param>
				<xsl:with-param name="id">saveSVG</xsl:with-param>
			</xsl:call-template>
			<img>
				<xsl:attribute name="src"><xsl:value-of select="$context"/><xsl:text>/svg-buttons/spacer.gif</xsl:text></xsl:attribute>
				<xsl:attribute name="style"><xsl:text>width:10</xsl:text></xsl:attribute>
			</img>

			<xsl:call-template name="tool">
				<xsl:with-param name="title">Delete</xsl:with-param>
				<xsl:with-param name="onclick">svgCut();</xsl:with-param>
				<xsl:with-param name="src">svg-buttons/cut.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/arrow.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/arrowplus.gif</xsl:with-param>
				<xsl:with-param name="id">svgArrowPlus</xsl:with-param>
			</xsl:call-template>
			<xsl:call-template name="tool">
				<xsl:with-param name="title">Smaller arrowhead</xsl:with-param>
				<xsl:with-param name="onclick">setArrowSize(-1);</xsl:with-param>
				<xsl:with-param name="src">svg-buttons/arrowminus.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/line-pressed.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/lineplus.gif</xsl:with-param>
				<xsl:with-param name="id">svgLinePlus</xsl:with-param>
			</xsl:call-template>
			<xsl:call-template name="tool">
				<xsl:with-param name="title">Thinner line</xsl:with-param>
				<xsl:with-param name="onclick">setStrokeWidth(-1);</xsl:with-param>
				<xsl:with-param name="src">svg-buttons/lineminus.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/circle.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/text.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/textplus.gif</xsl:with-param>
				<xsl:with-param name="id">svgTextPlus</xsl:with-param>
			</xsl:call-template>
			<xsl:call-template name="tool">
				<xsl:with-param name="title">Smaller font</xsl:with-param>
				<xsl:with-param name="onclick">setFontSize(-4);</xsl:with-param>
				<xsl:with-param name="src">svg-buttons/textminus.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/bold.gif</xsl:with-param>
			...
			<xsl:call-template name="tool">
				...
				<xsl:with-param name="src">svg-buttons/italic.gif</xsl:with-param>
