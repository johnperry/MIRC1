...
public class DestinationPanel extends JPanel {
	...
	private class InstructionPanel extends Box {
		public InstructionPanel() {
			...
			JLabel label2 = new JLabel("[http://host:port/trial/import/doc]");
			JLabel label3 = new JLabel("[https://host:port/trial/import/doc]");
			JLabel label4 = new JLabel("[dicom://destinationAET:senderAET@host:port]");
			JLabel label5 = new JLabel("[http://host:port/storageservice/submit/doc]");
