 ...
 */
public class MircQuery extends Hashtable<String, String> {

	static final Logger logger = Logger.getLogger(MircQuery.class);
	...
	public MircQuery(String freetext) {
		super();
	...
	/**
	 * Construct a MircQuery from an XML document in the form
	 * described on the RSNA MIRC wiki.
	 * @param queryDoc the MIRCquery XML DOM object.
	 */
	public MircQuery(Document queryDoc) {
		super();
