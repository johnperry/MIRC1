...
public class SopClass {
	...
	/**
	 * Tests whether a SOP Class corresponds to a raw data object.
	 * @param sop the SOPClassUID
	 * @return true if sop corresponds to a raw data object; false otherwise.
	 */
	public static boolean isRawData(String sop) {
		if (sop == null) return false;
		sop = sop.trim();
		return sop.equals(rawDataSopClass);
	}
